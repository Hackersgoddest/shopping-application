      ...
      <div v-if="productStore.loadedData"
        ...
        <figure @click="loadData(productStore.categoryItem[0].id)"
          ...
          <div
            ...
            <img class="h-[90%] w-full" src="../../../assets/female-shopping.png" alt="customer picture" />
          </div>
          <figcaption
        ...
        <figure @click="loadData(productStore.categoryItem[1].id)"
          ...
          <div
            class="w-full flex-1 flex justify-center items-end bg-emerald-200 rounded-tl-xl rounded-tr-xl rounded-br-3xl rounded-bl-3xl">
            <img class="h-[90%] w-full" src="../../../assets/man-shopping.png" alt="customer picture" />
          </div>
          <figcaption
            class="flex flex-col flex-wrap justify-center items-center bg-white h-28 rounded-bl-xl rounded-br-xl">
            <div>
        ...
        <figure @click="loadData(productStore.categoryItem[2].id)"
          ...
          <div
            class="w-full flex-1 flex justify-center items-end bg-emerald-200 rounded-tl-xl rounded-tr-xl rounded-br-3xl rounded-bl-3xl">
            <img class="h-full w-full rounded-tl-md rounded-tr-md" src="../../../assets/smartphone.png"
        ...
        <figure @click="loadData(productStore.categoryItem[3].id)"
          class="h-96 sm:max-w-xs flex flex-col bg-white justify-between shadow-lg shadow-gray-500 rounded-xl hover:cursor-pointer">
          <div
            class="w-full flex-1 flex justify-center items-center bg-white rounded-tl-xl rounded-tr-xl rounded-br-3xl rounded-bl-3xl">
            <img class="h-full w-full rounded-tl-md rounded-tr-md" src="../../../assets/home-and-living.jpg"
              alt="customer picture" />
          </div>
          <figcaption
            class="flex flex-col flex-wrap justify-center items-center bg-white h-28 rounded-bl-xl rounded-br-xl">
        ...
        <figure @click="loadData(productStore.categoryItem[4].id)"
          ...
          <div
            class="w-full flex-1 flex justify-center items-end bg-emerald-200 rounded-tl-xl rounded-tr-xl rounded-br-3xl rounded-bl-3xl">
            <img class="h-full w-full rounded-tl-md rounded-tr-md" src="../../../assets/electronics.jpeg"
              alt="customer picture" />
          </div>
          <figcaption
            class="flex flex-col flex-wrap justify-center items-center bg-white h-28 rounded-bl-xl rounded-br-xl">
        ...
        <figure @click="loadData(productStore.categoryItem[5].id)"
          ...
          <div
            class="w-full flex-1 flex justify-center items-end bg-emerald-200 rounded-tl-xl rounded-tr-xl rounded-br-3xl rounded-bl-3xl">
            <img class="h-full w-full rounded-tl-md rounded-tr-md" src="../../../assets/cosmetics.jpeg"
              alt="customer picture" />
          </div>
          <figcaption
            class="flex flex-col flex-wrap justify-center items-center bg-white h-28 rounded-bl-xl rounded-br-xl">
